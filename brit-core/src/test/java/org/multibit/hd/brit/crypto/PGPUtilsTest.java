...
public class PGPUtilsTest {
  ...
  public void testPGPEncryptDecrypt() throws Exception {
    ...
    PGPPublicKey encryptionKey = org.multibit.hd.brit.core.crypto.PGPUtils.readPublicKey(publicKeyRingInputStream);
    ...
    org.multibit.hd.brit.core.crypto.PGPUtils.encryptFile(encryptedOutputStream, inputFile, encryptionKey);
    ...
    org.multibit.hd.brit.core.crypto.PGPUtils.decryptFile(encryptedInputStream, rebornPlainTextOutputStream, secretKeyRingInputStream, TEST_DATA_PASSWORD);
  ...
  public void testLoadPGPPublicKeyFromASCIIArmoredFile() throws Exception {
    ...
    log.debug("Loading public key from\n'{}'", publicKeyFile.getAbsolutePath());
    FileInputStream publicKeyInputStream = new FileInputStream(publicKeyFile);

    PGPPublicKey publicKey = org.multibit.hd.brit.core.crypto.PGPUtils.readPublicKey(publicKeyInputStream);
    assertThat(publicKey).isNotNull();
    log.debug("Loaded PGP public key :\nAlgorithm: {}\nbitStrength: {}\nfingerprint: {}",
      publicKey.getAlgorithm(),
      publicKey.getBitStrength(),
      Utils.HEX.encode(publicKey.getFingerprint())
    );
